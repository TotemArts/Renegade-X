...
public:
	...
	/** Called when a particle system is created and set, allows extra handling and tracking to support particle template reuse for multiple trails when used with StartUsingPSysComp */
	virtual void StartUsingPSysComp(class UComponent* PSysComp) {}

	/** Checks if this attached particle system component should be used by this trail */
	virtual UBOOL ShouldUsePSysComp(class UComponent* PSysComp);
}
