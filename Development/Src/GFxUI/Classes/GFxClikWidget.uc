...
private function AS3AddEventListener(string type, GFxObject o, bool useCapture=false, int listenerPriority=0, bool useWeakReference=true) { ActionScriptVoid("addEventListener"); }
