 ...
 */
class OnlineSubsystemPlayGameService extends OnlineSubsystemCommonImpl
	native
...
/** The string prepended to the achievement ID to generate a globally unique achievement identifier (like com_epicgames_mygame_achievement_). It needs to match what you put in the Amazon Dev portal */
var config string AchievementPrefix;

/** The string prepended to the view ID to generate a globally unique leaderboard identifier (like com.epicgames.mygame.leaderboard_). It needs to match what you put in the Amazon Dev portal */
var config string LeaderboardPrefix;
