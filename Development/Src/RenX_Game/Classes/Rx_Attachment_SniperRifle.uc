class Rx_Attachment_SniperRifle extends Rx_WeaponAttachment;
...
DefaultProperties
{
	Begin Object Name=SkeletalMeshComponent0
		SkeletalMesh=SkeletalMesh'RX_WP_SniperRifle.Mesh.SK_DSR50_3P'		// SkeletalMesh'RX_WP_SniperRifle.Mesh.SK_WP_SniperRifle_3P'
		//Translation=(Y=2,Z=-2)
