class Rx_Building_Helipad_GDI extends Rx_Building_GDI_VehicleFactory
   placeable;
...
{
	MineLimit=3
	BuildingInternalsClass  = Rx_Building_Helipad_GDI_Internals
	...
	Begin Object Name=PointLightComponent2
		...
		LightColor  = (B=57,G=206,R=255,A=0)
		Radius = 200
		FalloffExponent = 4.0
		Brightness = 2.0
