class Rx_Building_TeamSilo_GDI extends Rx_Building_GDI_MoneyFactory
	placeable;
...
{
   TeamID = TEAM_GDI
   BuildingInternalsClass = Rx_Building_TeamSilo_GDI_Internals
   bSignificant		= false
   bTriggerUnderAttack = true

	Begin Object Name=Static_Exterior
		StaticMesh = StaticMesh'RX_BU_TeamSilo.Meshes.SM_Silo_GDI'
		LightingChannels=(bInitialized=True,Static=True)
	End Object
	
	Begin Object Name=Static_Interior
        StaticMesh = StaticMesh'RX_BU_TeamSilo.Meshes.SM_Silo_Exterior_GDI'
		LightingChannels=(bInitialized=True,Static=True)
    End Object
	...
	IconTexture = Texture2D'RenxHud.T_Tech_Silo_GDI'
}
