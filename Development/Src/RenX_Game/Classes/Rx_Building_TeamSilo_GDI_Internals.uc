...
defaultproperties
{
   ...
   FriendlyBuildingSounds(BuildingDestroyed)		=	SoundNodeWave'RX_EVA_VoiceClips.gdi_eva.S_EVA_GDI_GDISilo_Destroyed'
   FriendlyBuildingSounds(BuildingUnderAttack)		=	SoundNodeWave'RX_EVA_VoiceClips.gdi_eva.S_EVA_GDI_GDISilo_UnderAttack'
   FriendlyBuildingSounds(BuildingRepaired)		=	None
   FriendlyBuildingSounds(BuildingDestructionImminent) 	=	None
   EnemyBuildingSounds(BuildingDestroyed)		=	SoundNodeWave'RX_EVA_VoiceClips.Nod_EVA.S_EVA_Nod_GDISilo_Destroyed'
   EnemyBuildingSounds(BuildingUnderAttack)		=	SoundNodeWave'RX_EVA_VoiceClips.Nod_EVA.S_EVA_Nod_GDISilo_UnderAttack'
