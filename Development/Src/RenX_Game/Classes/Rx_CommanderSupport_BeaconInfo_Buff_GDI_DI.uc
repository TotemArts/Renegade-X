...
class Rx_CommanderSupport_BeaconInfo_Buff_GDI_DI extends Rx_CommanderSupport_BeaconInfo_AOEBuff; 
...
MaxCastRange = 0
AOE_Radius = 2000
FireSoundCue = SoundCue'RX_CharSnd_Generic.Ambient_Yelling.AmbientYell_GDI_ComeGetIt_Cue'
bBroadcastToEnemy 	= false

ModifierClass = class'Rx_StatModifierInfo_GDI_DI'

PowerName			= "Defensive Initiative"
