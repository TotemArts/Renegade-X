...
defaultproperties
{
    ...
    VehicleDamageScaling=0.6 //0.42
    NodeDamageScaling=0.5
    VehicleMomentumScaling=0.5

    CustomTauntIndex=10
    lightArmorDmgScaling=0.7 //0.42
    BuildingDamageScaling=0.42
	MCTDamageScaling=3.5 //22 Damage
	////Infantry Armour Types//////
	Inf_FLAKDamageScaling = 0.5 //0.7   //FLAK infantry armour (Standard rule is explosive weapons does  30% less, while gun damage does 30% more)
	Inf_KevlarDamageScaling = 1.2 //1.0	//Kevlar (General rule is 15% less damage from direct hits/bullets, but no penalties)
