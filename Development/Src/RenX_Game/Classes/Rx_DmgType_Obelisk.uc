class Rx_DmgType_Obelisk extends Rx_DmgType;
...
defaultproperties
{
	...
	PS_AttachToGib=ParticleSystem'RX_WP_FlameThrower.Effects.FX_Flame_Explode'
	...
	BoneToAttach="b_hip"
	PS_AttachToBody=ParticleSystem'RX_WP_FlameThrower.Effects.FX_Flame_Explode'
}