class Rx_InventoryManager_GDI_Sydney_Suit extends Rx_InventoryManager_Adv_GDI;
...
DefaultProperties
{
	...
	SidearmWeapons[0] = class'Rx_Weapon_TiberiumAutoRifle' //class'Rx_Weapon_HeavyPistol'//1
