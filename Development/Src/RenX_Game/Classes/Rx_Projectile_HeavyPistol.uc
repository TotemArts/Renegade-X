class Rx_Projectile_HeavyPistol extends Rx_Projectile;
...
//    bCollideWorld=true
    ...
    ExplosionLightClass=class'RenX_Game.Rx_Light_AutoRifle_MuzzleFlash'
    MyDamageType=class'Rx_DmgType_HeavyPistol'
}
