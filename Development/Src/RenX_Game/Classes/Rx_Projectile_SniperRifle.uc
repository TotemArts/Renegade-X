class Rx_Projectile_SniperRifle extends Rx_Projectile;

DefaultProperties
{

	ProjFlightTemplate=ParticleSystem'RX_FX_Munitions.bullets.P_Bullet_Sniper'
    ...
    MyDamageType=class'Rx_DmgType_SniperRifle'
