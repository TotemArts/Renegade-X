class Rx_Rcon_Command_PrivateAdminMessage extends Rx_Rcon_Command;
...
function string trigger(string parameters)
{
	...
	Rx_BroadcastHandler(`WorldInfoObject.Game.BroadcastHandler).BroadcastPM(None, Rx_Controller(PRI.Owner), parameters, 'PM_AdminMsg');
	return "";
}
...
{
	triggers.Add("pamsg");
	Syntax="Syntax: pamsg Player[String] Message[String]";
}
