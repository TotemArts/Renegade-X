class Rx_StatModifierInfo_GDI_DI extends Rx_StatModifierInfo; //Buffs/Debuffs/Special functions
...
DefaultProperties
{
	...
	SpeedModifier 	= 0.0 //-0.1 //*X

	//Weapons
	DamageBoostMod 	= 0.0  //*X
	RateOfFireMod 	= 0.0 //*X 
	ReloadSpeedMod 	= 0.0//0.15 //*X 
	...
	ModificationName = "Defensive Initiative"
