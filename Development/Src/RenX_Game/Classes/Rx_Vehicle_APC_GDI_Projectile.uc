/*********************************************************
*
* File: Rx_Vehicle_APC_GDI_Projectile.uc
...
*
*********************************************************/
class Rx_Vehicle_APC_GDI_Projectile extends Rx_Vehicle_Projectile;
...
DefaultProperties
{
 ...
 //   ExplosionSound=SoundCue'RX_SoundEffects.Bullet_Impact.SC_BulletImpact_Dirt'
    ...
    MyDamageType=Class'Rx_DmgType_APC_GDI'
    ...
    ProjectileLightClass=class'Rx_Light_Bullet_GDI' // TODO
}
