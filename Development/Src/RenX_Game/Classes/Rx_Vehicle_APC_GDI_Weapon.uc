/*********************************************************
*
* File: Rx_Vehicle_APC_GDI_Weapon.uc
...
*
*********************************************************/
class Rx_Vehicle_APC_GDI_Weapon extends Rx_Vehicle_Weapon_Reloadable;
...
DefaultProperties
{
    ...
    VehicleClass=Class'RenX_Game.Rx_Vehicle_APC_GDI'
...
//    WeaponProjectiles(0) = Class'Rx_Vehicle_APC_GDI_Projectile'
    WeaponFireSnd(1)     = none //SoundCue'RX_VH_APC_GDI.Sounds.SC_APC_Fire'
//    WeaponFireTypes(1)   = EWFT_Projectile
//    WeaponProjectiles(1) = Class'Rx_Vehicle_APC_GDI_Projectile'
    // AI
	...
	InstantHitDamageTypes(0)=class'Rx_DmgType_APC_GDI'
	InstantHitDamageTypes(1)=class'Rx_DmgType_APC_GDI'
