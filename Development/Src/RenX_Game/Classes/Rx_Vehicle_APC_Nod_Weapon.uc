...
*
*********************************************************/
class Rx_Vehicle_APC_Nod_Weapon extends Rx_Vehicle_Weapon_Reloadable;
...
DefaultProperties
{
    ...
    VehicleClass=Class'RenX_Game.Rx_Vehicle_APC_Nod'
    ...
    WeaponFireSnd(0)     = none //SoundCue'RX_VH_APC_Nod.Sounds.SC_APC_Fire'
//    WeaponFireTypes(0)   = EWFT_Projectile
//    WeaponProjectiles(0) = Class'Rx_Vehicle_APC_Nod_Projectile'
    WeaponFireSnd(1)     = none //SoundCue'RX_VH_APC_Nod.Sounds.SC_APC_Fire'
...
//    WeaponProjectiles(1) = Class'Rx_Vehicle_APC_Nod_Projectile'
	...
	InstantHitDamageTypes(0)=class'Rx_DmgType_APC_Nod'
	InstantHitDamageTypes(1)=class'Rx_DmgType_APC_Nod'
	...
	bOkAgainstArmoredVehicles = False
