/*********************************************************
*
* File: Rx_Vehicle_Hovercraft_Cannon.uc
...
*
*********************************************************/
class Rx_Vehicle_Hovercraft_Cannon extends Rx_Vehicle_Projectile;
...
simulated function SetExplosionEffectParameters(ParticleSystemComponent ProjExplosion)
{
    ...
    ProjExplosion.SetScale(1.0f); //(1.25f);
}
...
DefaultProperties
{
	...
	ProjFlightTemplate=ParticleSystem'RX_FX_Munitions.shells.P_Shell_Small'
	...
	MyDamageType=Class'Rx_DmgType_HoverCraft_Cannon'
