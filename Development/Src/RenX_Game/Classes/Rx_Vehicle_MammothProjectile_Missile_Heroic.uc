...
class Rx_Vehicle_MammothProjectile_Missile_Heroic extends Rx_Vehicle_MammothProjectile_Missile;
...
DefaultProperties
{
	...
	ProjFlightTemplate= ParticleSystem'RX_FX_Munitions.Missile.P_Missile_Heroic' //ParticleSystem'RX_FX_Munitions.Missile.P_Missile_Rockets'		// ParticleSystem'RX_FX_Munitions.Missile.P_Missile_RocketLauncher'
/**
