class Rx_Vehicle_MediumTank_Gun extends Rx_Vehicle_Projectile;;
...
DefaultProperties
{
	...
	Vet_SpeedIncrease(3)=2.0 //Heroic (N/A for AutoRifle, as it gets hitscan)
