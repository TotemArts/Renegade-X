class Rx_Weapon_Pistol_UnSILENCED extends Rx_Weapon_Reloadable;
...
DefaultProperties
{
	...
	Begin Object Name=FirstPersonMesh
		SkeletalMesh=SkeletalMesh'RX_WP_Pistol.Mesh.SK_Pistol_1P'		// SkeletalMesh'RX_WP_Pistol.Mesh.SK_WP_Pistol_1P_Alternative'
	...
	Begin Object Name=PickupMesh
		SkeletalMesh=SkeletalMesh'RX_WP_Pistol.Mesh.SK_Pistol_Back'		// SkeletalMesh'RX_WP_Pistol.Mesh.SK_WP_Pistol_Back'
		Scale=1.0
	End Object
	
	ArmsAnimSet = AnimSet'RX_WP_Pistol.Anims.AS_SilencedPistol_Arms'			// AnimSet'RX_WP_Pistol.Anims.AS_Pistol_Arms_Alternative'

	AttachmentClass = class'Rx_Attachment_Pistol_UnSILENCED'
...
//	PutDownTime=0.3667
	...
	HeadShotDamageMult=1.666667 //4.0 //3.5
	...
	WeaponFireSnd[0]=SoundCue'RX_WP_Pistol.Sounds.SC_Pistol_Fire'
	WeaponFireSnd[1]=None
	
	WeaponDistantFireSnd = SoundCue'RX_WP_Pistol.Sounds.SC_Pistol_DistantFire'
	...
	WeaponIconTexture=Texture2D'RX_WP_Pistol.UI.T_WeaponIcon_Pistol_NoSilencer'
	...
	/** one1: Added. */
	BackWeaponAttachmentClass = class'Rx_BackWeaponAttachment_Pistol_UnSILENCED'
