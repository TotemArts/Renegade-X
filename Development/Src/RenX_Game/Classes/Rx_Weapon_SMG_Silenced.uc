...
DefaultProperties
{
	...
	Begin Object Name=FirstPersonMesh
		SkeletalMesh=SkeletalMesh'RX_WP_Pistol.Mesh.SK_MachinePistol_1P_Silenced'
	...
	Begin Object Name=PickupMesh
		SkeletalMesh=SkeletalMesh'RX_WP_Pistol.Mesh.SK_MachinePistol_3P_Silenced' //SkeletalMesh'RX_WP_Pistol.Mesh.SK_MachinePistol_Back'
		Scale=1.0
	End Object
	
	ArmsAnimSet = AnimSet'RX_WP_Pistol.Anims.AS_MachinePistol_Arms'

	AttachmentClass = class'Rx_Attachment_SMG_Silenced'
...
//	PutDownTime=0.35
	...
	InstantHitDamage(0)=12 //7
	InstantHitDamage(1)=12 //7
...
//	WeaponProjectiles(1)=class'RenX_Game.Rx_Projectile_SMG'
    ...
    WeaponFireSnd[0]=SoundCue'RX_WP_Pistol.Sounds.SC_SMG_Silenced_FireLoop'//SoundCue'RX_WP_Pistol.Sounds.SC_SMG_FireLoop'
    WeaponFireSnd[1]=none
    WeaponPostFireSnd[0]=SoundCue'RX_WP_Pistol.Sounds.SC_SMG_Silenced_FireStop'//SoundCue'RX_WP_Pistol.Sounds.SC_SMG_FireStop'
...
//    WeaponFireSnd[1]=none
	...
	WeaponIconTexture=Texture2D'RX_WP_Pistol.UI.T_WeaponIcon_SMG_Silenced'//Texture2D'RX_WP_Pistol.UI.T_WeaponIcon_SMG'
	...
	/** one1: Added. */
	BackWeaponAttachmentClass = class'Rx_BackWeaponAttachment_SMG_Silenced'
}
