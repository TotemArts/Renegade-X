/*********************************************************
*
* File: TS_Vehicle_TickTank_Bullet.uc
...
*
*********************************************************/
class TS_Vehicle_TickTank_Bullet extends Rx_Vehicle_Projectile;
...
//    ProjExplosionTemplate=ParticleSystem'RX_FX_Munitions.Impact_Bullet.P_Bullet_Impact_Dirt'
//    ExplosionSound=SoundCue'RX_SoundEffects.Bullet_Impact.SC_BulletImpact_Dirt'
    ...
    MyDamageType=Class'TS_Vehicle_TickTank_Bullet_DmgType'
    ...
    ProjectileLightClass=class'Rx_Light_Bullet_Nod' // TODO
}
