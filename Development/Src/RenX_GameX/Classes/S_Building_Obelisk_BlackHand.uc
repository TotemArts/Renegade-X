class S_Building_Obelisk_BlackHand extends Rx_Building_GDI_Defense
   placeable
...
defaultproperties
{
    //MineLimit=3
    TeamID                 = TEAM_GDI
    BuildingInternalsClass = S_Building_Obelisk_Internals_BlackHand
    GDIColor    = "#3260FF"

    Begin Object Name=Static_Exterior
        StaticMesh=StaticMesh'S_BU_Oblisk.Mesh.SM_Obelisk_New'
    End Object

    Begin Object Name=Static_Interior
        StaticMesh=StaticMesh'S_BU_Oblisk.Mesh.SM_Obelisk_Interior'
    End Object

    Begin Object Name=Static_Interior_Complex
        StaticMesh=StaticMesh'S_BU_Oblisk.Mesh.SM_Obelisk_Interior_Complex'
    End Object 

    Begin Object Name=PT_Screens
        StaticMesh=StaticMesh'S_BU_Oblisk.Mesh.SM_Obelisk_Screens'
    End Object
