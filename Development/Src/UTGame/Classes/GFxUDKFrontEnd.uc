...
{
	if (GFxUDKFrontEnd_JoinGame(ViewStack[ViewStack.Length-1]) != none)
		return GFxUDKFrontEnd_JoinGame(ViewStack[ViewStack.Length-1]).OnFilterButtonInput(ControllerId, ButtonName, InputEvent);
