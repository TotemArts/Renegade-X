...
event InitFilters()
{
	SetStringProperty(PROPERTY_CUSTOMGAMEMODE, GameClass);
}
...
defaultproperties
{
	...
	Properties(0)=(PropertyId=PROPERTY_CUSTOMGAMEMODE,Data=(Type=SDT_String))
	PropertyMappings(0)=(Id=PROPERTY_CUSTOMGAMEMODE,Name="CustomGameMode")
	...
	(OrClauses=((OrParams=((EntryId=CONTEXT_GAME_MODE,EntryType=OGSET_LocalizedSetting,ComparisonType=OGSCT_Equals))),
				...
				(OrParams=((EntryId=PROPERTY_CUSTOMGAMEMODE,EntryType=OGSET_Property,ComparisonType=OGSCT_Equals)))
	))}
}
